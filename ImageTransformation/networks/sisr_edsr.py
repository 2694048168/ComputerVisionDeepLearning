...
"""
@Function: EDSR: Image Super-Resolution with PyTorch
...
@Publisher: IEEE of Computer Vision and Pattern Recognition Workshop (CVPRW)
# ===========================================================================
...
if __name__ == "__main__":
    model = EDSR(in_channels=3, out_channels=3, num_features=64, num_blocks=3, res_scale=1, upscale_factor=4)
    print("======== The Summary of EDSR Model ========")
    print(model)
    print("======== The Summary of EDSR Model ========")
    torchkeras.summary(model, input_shape=(3, 64, 64))
# ---------------------------------------------------------------
# python networks/sisr_edsr.py | tee networks/EDSR_model.txt
# ---------------------------------------------------------------